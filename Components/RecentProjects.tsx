              ...
              <PinContainer href={link} title={link}>
                <div className='flex items-center justify-center h-[20vg] lg:h-[30vh] mb-10 sm:w-96 w-[80vw] relative overflow-hidden'>
                  <div className='relative w-full h-full overflow-hidden lg:rounded-3xl bg-[#13162d] '>
                    <Image priority={true} src='/bg.png' alt="bg-img" className='w-full h-full' width={100} height={100} />
                  </div>
                  <Image priority={true} width={1000} height={1000} src={img} alt={title} className='z-10 absolute bottom-0 h-full w-full' />
                </div>
