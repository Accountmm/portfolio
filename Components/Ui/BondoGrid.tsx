...
export const BentoGridItem = ({
  ...
  const leftLists = ["React", "Angular", "Typescript"];
  const rightLists = ["VueJS", "Next", "Sentry"];
  ...
  const handleCopy = () => {
    const text = "proweb2008.m@gmail.com";
        ...
        >
          ...
          {id === 3 && (
            <div className="flex gap-1 lg:gap-5 w-fit absolute -right-3 lg:-right-2">
              {/* tech stack lists */}
              <div className="flex flex-col  gap-5 md:gap-3 lg:gap-6">
